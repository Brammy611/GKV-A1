...
////------------------------------------------------------------------
//void display() {
//    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT); // clear frame and depth buffers
...
//	glutInit(&argc, argv); // Inisialisqasi GLUT
//    glutInitDisplayMode(GLUT_DOUBLE | GLUT_DEPTH | GLUT_RGB); // initialize GLUT
//    glutInitWindowSize(800, 600);  // Set ukuran jendela (width x height)
